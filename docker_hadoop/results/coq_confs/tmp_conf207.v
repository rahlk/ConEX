...
Definition a_mapred_config: MapRedConfig.
    ...
    (mapreduce_input_fileinputformat_split_minsize.mk false 59897336%N _ )
    ...
    (mapreduce_job_max_split_locations.mk false 8%positive _ )
    ...
    (mapreduce_reduce_shuffle_input_buffer_percent.mk false (80/100)%R _ )
    ...
    (mapreduce_shuffle_max_connections.mk false (Some 6%positive) _ )
