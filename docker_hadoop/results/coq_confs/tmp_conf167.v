...
Definition a_mapred_config: MapRedConfig.
    ...
    (mapreduce_job_jvm_numtasks.mk false None _ )
    ...
    (mapreduce_map_java_opts.mk false (mk_java_opts 3072%positive 100%positive) _ )
    ...
    (yarn_app_mapreduce_am_command__opts.mk false (mk_java_opts 1350%positive 100%positive) _ )
