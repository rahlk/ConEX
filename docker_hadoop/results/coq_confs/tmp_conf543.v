Require Import hadoop_config.
    ...
    unshelve refine (
        mk_core_config
        (io_file_buffer_size.mk false 81920%positive _ )
    (io_map_index_interval.mk false 128%positive _ )
    (io_map_index_skip.mk false 0%N _ )
    (io_seqfile_compress_blocksize.mk false 1127108%positive _ )
...
Definition a_mapred_config: MapRedConfig.
    ...
    (mapreduce_job_reduce_slowstart_completedmaps.mk false (20/100)%R _ )
    ...
    (mapreduce_map_java_opts.mk false (mk_java_opts 983%positive 100%positive) _ )
    ...
    (mapreduce_reduce_cpu_vcores.mk false 4%positive _ )
    (mapreduce_reduce_input_buffer_percent.mk false (40/100)%R _ )
    (mapreduce_reduce_java_opts.mk false (mk_java_opts 6144%positive 100%positive) _ )
    (mapreduce_reduce_markreset_buffer_percent.mk false (0/100)%R _ )
    (mapreduce_reduce_memory_mb.mk false 6144%positive _ )
    ...
    (mapreduce_shuffle_max_threads.mk false 10%N _ )
    ...
    (yarn_app_mapreduce_am_resource_mb.mk false 3400%positive _ )
