...
Definition a_mapred_config: MapRedConfig.
    ...
    (mapreduce_job_max_split_locations.mk false 13%positive _ )
    ...
    (mapreduce_map_memory_mb.mk false 4096%positive _ )
    ...
    (mapreduce_map_sort_spill_percent.mk false (80/100)%R _ )
