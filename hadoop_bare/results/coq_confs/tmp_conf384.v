...
Definition a_mapred_config: MapRedConfig.
    ...
    (mapreduce_job_ubertask_maxreduces.mk false (Some 7%positive) _ )
    ...
    (mapreduce_reduce_input_buffer_percent.mk false (0/100)%R _ )
    ...
    (mapreduce_reduce_memory_mb.mk false 10240%positive _ )
