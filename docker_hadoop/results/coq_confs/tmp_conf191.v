Require Import hadoop_config.
    ...
    unshelve refine (
        mk_core_config
        (io_file_buffer_size.mk false 73728%positive _ )
    (io_map_index_interval.mk false 128%positive _ )
    (io_map_index_skip.mk false 0%N _ )
    (io_seqfile_compress_blocksize.mk false 1200000%positive _ )
...
Definition a_mapred_config: MapRedConfig.
    ...
    (mapreduce_input_fileinputformat_split_maxsize.mk false 402653184%positive _ )
    ...
    (mapreduce_job_ubertask_maxreduces.mk false (Some 4%positive) _ )
    ...
    (mapreduce_map_java_opts.mk false (mk_java_opts 901%positive 100%positive) _ )
    ...
    (mapreduce_reduce_shuffle_memory_limit_percent.mk false (30/100)%R _ )
    ...
    (mapreduce_task_io_sort_factor.mk false 6%positive _ )
    ...
    (yarn_app_mapreduce_am_command__opts.mk false (mk_java_opts 1200%positive 100%positive) _ )
    ...
    (yarn_app_mapreduce_am_resource_mb.mk false 2600%positive _ )
